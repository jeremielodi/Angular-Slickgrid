...
export class GridAngularComponent implements OnInit {
  ...
  prepareGrid() {
    this.columnDefinitions = [
      ...
      { id: 'action', name: 'Action', field: 'id', cssClass: 'pointer', minWidth: 40, formatter: customActionFormatter, width: 70 }
    ];
    ...
    DropDownService.init(
      {
        ...
        CustomActionFormatter: CustomActionFormatterComponent,
        args,
        actionColumnIndex: 6, 
        parent : this,
        $
